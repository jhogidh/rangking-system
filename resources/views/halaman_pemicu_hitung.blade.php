                ...
                <div class="tab-content" id="setting-content">
                    <div class="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel"
                        ...
                        <div class="add-items d-flex px-3 mb-0">
                            <form action="{{ route('perankingan.hitung') }}" method="POST">
                                @csrf
                                ...
                                <button type="submit">Hitung dan Analisis Perankingan</button>
                            </form>
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" action="/siswa" method="POST">
                                            ...
                                            <div class="form-group">
                                                <label for="kodesiswa">Kode</label>
                                                <input type="text" class="form-control" name="kodesiswa"
                                                    placeholder="Kode">
                                            </div>
                                            <div class="form-group">
