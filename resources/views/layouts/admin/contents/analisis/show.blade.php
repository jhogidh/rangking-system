            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">
                        <!-- Menampilkan data semester dan kelas yang dihitung -->
                        Semester: <strong>{{ $semester->nama }}
                            ({{ $semester->tahunAjaran->tahun_mulai }}/{{ $semester->tahunAjaran->tahun_selesai }})</strong>
                        <br>
